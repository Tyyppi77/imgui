...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Dark\0Light\0Classic\0Dark Blue\0Dark Grey\0"))
    {
        switch (style_idx)
        {
        ...
        case 3: ImGui::StyleColorsDarkBlue(); break;
        case 4: ImGui::StyleColorsDarkGrey(); break;
        }
        return true;
    }
    return false;
