...
namespace ImGui
{
    ...
    IMGUI_API void          ShowMetricsContent();
    ...
    IMGUI_API void          StyleColorsDarkBlue(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsDarkGrey(ImGuiStyle* dst = NULL);
...
enum ImGuiCol_
{
    ...
    ImGuiCol_EditorIconNeutral,
    ImGuiCol_EditorIconHighlight,
    ImGuiCol_COUNT
};
